...
BUTTON
  **Usage:** ``button_<#> <menu #>``
  **Example:** ``button_3 2`` to activate button 3 on menu 2.
  ...
  The button number should correspond to the hotbar action it's mapped to.
...
SET_GRID_ID <Optional Tag> - Sets unique tag for the grid.
* GridID is used to distinguish between other ships/stations when docking with merge blocks.
* Attribute is shared with other Laika Softworks scripts like Pressure Chief and USAP.
